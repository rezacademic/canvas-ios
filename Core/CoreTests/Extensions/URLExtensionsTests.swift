...
class URLExtensionsTests: XCTestCase {
    ...
    func testAppGroupCachesDirectory() {
        let expected = URL.Directories.sharedContainer(appGroup: "group.raccanvas.shared")!.appendingPathComponent("caches", isDirectory: true)
        let url = URL.Directories.caches(appGroup: "group.raccanvas.shared")
...
class DatabaseURLTests: XCTestCase {
    let appGroup = "group.dev.shadowing.icanvas"
